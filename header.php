        ...
        <nav class="navbar bg-white fixed-top">
            <div class="container-fluid">
                <div class="d-flex align-items-center g-4">
                    <a class="navbar-brand d-flex" href="<?php echo home_url(); ?>">
                        <?php if (get_field('header_logo', 'option')) : ?>
                            <img src="<?php the_field('header_logo', 'option'); ?>" class="img-fluid" id="logo">
                        <?php else: ?>
                            <img src="<?php echo get_template_directory_uri(); ?>/images/logo.png" class="img-fluid" id="logo">
                        <?php endif; ?>
                    </a>
                ...
                <div class="offcanvas offcanvas-end text-white bg-black" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
                    ...
                    <div class="offcanvas-body">
                        ...
                        wp_nav_menu(array(
                            ...
                            'container'      => false,
                            'menu_class'     => 'navbar-nav flex-grow-1 p-4',
                            'add_li_class'   => 'nav-item', // Our custom argument for the <li>
                            'add_link_class' => 'nav-link text-uppercase ls-4 text-white' // Our custom argument for the <a>
                        ));
                        ?>
                    </div>
                </div>
